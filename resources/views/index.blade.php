...
<head>
    ...
    <title>Transport Bill Management</title>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                ...
                                                <input name="email" id="exampleEmail" placeholder="Email here" type="email" class="form-control" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="examplePassword" class="">Password</label>
                                                <input name="password" id="examplePassword" placeholder="Password here" type="password" class="form-control" value=""></div>
                                        </div>
                                    </div>
